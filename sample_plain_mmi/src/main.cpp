...
int main(int argc, char *argv[])
{
    ...
    app.setApplicationName(QStringLiteral("sample_plain_mmi"));

    QWidget window;
    window.setObjectName(QStringLiteral("plainMainWindow"));
    window.setWindowTitle(QStringLiteral("Sample Plain MMI"));
